                ...
                <td style="text-align: center;">
                    <form action="#" method="POST" enctype="multipart/form-data">
                      ...
                      <a data-toggle="modal" data-target="#{{$hd->id}}" class="btn btn-warning btn-xs">
                        ...
                        <a href="#" class="btn btn-danger btn-xs" onclick="return confirm('Bạn chắc chắn muốn xoá tin?')">
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <button onclick="return confirm('Bạn muốn tiếp tục?')" type="submit" class="btn btn-primary">Đăng</button>
                    </div>
                    {!! Form::close() !!}
                  </div>
                </div>
