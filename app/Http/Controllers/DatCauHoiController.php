...
class DatCauHoiController extends Controller
{
    ...
    {
      $hoidap = DatCauHoi::orderby('created_at','desc')->paginate(6);
      $loai = 'hoidap';
    ...
    {
      $hoidap = DatCauHoi::where('active','0')->orderby('created_at','desc')->paginate(6);
      $loai = 'hoidap';
    ...
    {
        $dch = DatCauHoi::find($request->id_cauhoi);
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(DatCauHoi $datCauHoi)
    {
        //
    }
}
